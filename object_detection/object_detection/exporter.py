...
def freeze_graph_with_def_protos(
  ...
  # if not tf.train.Saver().checkpoint_exists(input_checkpoint):
    raise ValueError(
  ...
  with tf.Graph().as_default():
    ...
    with session.Session(config=config) as sess:
      if input_saver_def:
        ...
        # saver = tf.train.import_meta_graph('/media/hamhochoi/New Volume/MEGA/VCCorp/Logo Detection/export_graph/model.ckpt.meta')
